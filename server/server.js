 ...
 */
app.get('/api/horoscope/auspicious-times', (req, res) => {
  res.status(501).json({ message: 'Not implemented' });
});
 ...
 */
app.get('/api/reports/domains', (req, res) => {
  res.status(501).json({ message: 'Not implemented' });
});
 ...
 */
app.get('/api/reports/planet-transits', (req, res) => {
  res.status(501).json({ message: 'Not implemented' });
});
 ...
 */
app.get('/api/reports/auspicious-timings', (req, res) => {
  res.status(501).json({ message: 'Not implemented' });
});
 ...
 */
app.get('/api/reports/remedies', (req, res) => {
  res.status(501).json({ message: 'Not implemented' });
});
 ...
 */
app.get('/api/starbase/articles', (req, res) => {
  res.status(501).json({ message: 'Not implemented' });
});
 ...
 */
app.get('/api/starbase/articles/:id', (req, res) => {
  res.status(501).json({ message: 'Not implemented' });
});
